...
add_action( 'wpcf7_init', 'wtmw_wpcf7_add_shortcode_submit' );

function wtmw_wpcf7_add_shortcode_submit() {
	wpcf7_add_shortcode( 'submit', 'wtmw_wpcf7_submit_shortcode_handler' );
}

function wtmw_wpcf7_submit_shortcode_handler( $tag ) {
	...
	$atts['class'] = $tag->get_class_option( $class ) .' cta-form';
...
add_action( 'wpcf7_admin_init', 'wtmw_wpcf7_add_tag_generator_submit', 55 );

function wtmw_wpcf7_add_tag_generator_submit() {
	$tag_generator = WPCF7_TagGenerator::get_instance();
	$tag_generator->add( 'submit', __( 'submit', 'contact-form-7' ),
		'wpcf7_tag_generator_submit', array( 'nameless' => 1 ) );
}

function wtmw_wpcf7_tag_generator_submit( $contact_form, $args = '' ) {
