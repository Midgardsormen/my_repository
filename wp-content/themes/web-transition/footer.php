      ...
      <div class="container">
        <div class="row">
          <div class="coordonnees">
            <div class="bloc col-xs-6">
              <h5 class="lille">Lille
                <svg width="100%" height="100%" viewBox="0 0 27 68" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linecap:round;stroke-linejoin:round;stroke-miterlimit:10;">
              ...
              <p>
                943 avenue de la République<br/>
                59700 Marcq-en-Baroeul<br/>
                Tél: +33 (0)320 811 255
              </p>
            </div>
            <div class="bloc col-xs-6">
              <h5 class="paris">
                <!-- <i></i> -->
                <svg width="100%" height="100%" viewBox="0 0 44 60" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve" style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
        ...
        <div class="row">
          <div class="col-xs-12">
            <div class="wrap-mentions">
              ...
              <a class="email" href="mailto:contact@web-transition.com">contact@web-transition.com</a>
